...
const FILTERS = [
  ...
  { key: 'leaf', label: ' تشكيلة ليف - أواني مميزة', desc: ' تصميمات فريدة من الأواني المستوحاة من الطبيعة — من الأشكال الكلاسيكية إلى المربعات و المستطيلات العصرية، بلاستيك عالي الجودة و جميع الالوان متاحة.' },
  { key: 'nature', label: 'تشكيلة نيتشور - أشكال طبيعية', desc: 'تصاميم مستوحاه من الطبيعة — موجات وصخور وأصداف وأشكال بحرية و جبلية تضفي جمالاً فريداً.' },
  { key: 'villa', label: 'تشكيلة فيلا - أواني فاخرة', desc: ' تصماميم من الأواني الفاخرة — أحجام كبيرة وتصاميم راقية مثالية للحدائق و المداخل و المساحات الفاخرة، مصنوع من البولي بروبلين عالي الجودة و معالج ضد الاشعة فوق البنفسجية ومزود بنظام رى ذاتى ذكى..' }
];
