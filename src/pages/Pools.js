...
const poolProjects = [
  { 
    id: 1, 
    title: 'مشروع مسبح فيلا', 
    desc: 'تنفيذ أنظمة الفلترة المتطورة والأعمال الكهروميكانيكيةوالمدنية لمسبح فيلا  ', 
    images: [
  ...
  { 
    id: 2, 
    title: ' أعمال مسبح وحدات حياة لشقق المخدومة ', 
   ...
   { 
    id: 3, 
    title: '  الأعمال الكهروميكانيكية المسبح الأوليمبى بشرما  ', 
    desc: 'تنفيذ أنظمة الفلترة المتطورة والأعمال الكهروميكانيكيةوالمدنية لمسبح فيلا  ', 
    images: [
  ...
  { 
    id: 5, 
    title: ' أعمال المسبح الأوليمبى لمنتجع جدة', 
    desc: 'تنفيذ أنظمة الفلترة المتطورة والأعمال الكهروميكانيكيةوالمدنية لمسبح فيلا  ', 
    images: [
   ...
   { 
    id: 5, 
    title: ' أعمال مسبح ليروا سويتس الميدان ', 
    desc: 'تنفيذ أنظمة الفلترة المتطورة والأعمال الكهروميكانيكيةوالمدنية لمسبح فيلا  ', 
    images: [
   ...
   { 
    id: 6, 
    title: ' أعمال مسبح هوليداى ان الميدان', 
    desc: 'تنفيذ أنظمة الفلترة المتطورة والأعمال الكهروميكانيكيةوالمدنية لمسبح فيلا  ', 
    images: [
  ...
  return (
    <div className="page page--pools">
      ...
      <PageHero
        ...
        description="نصمم وننفذ حمامات السباحة شاملة الاعمال المدنية والمعمارية والأنظمة الكهروميكانيكية باحترافية عالية في مختلف أنحاء المملكة"
      />
